...
const why = [
  ...
  {
    id: "all-types",
    text: "All elevator types: traction, hydraulic, commercial, residential",
  },
];
  ...
  return (
    <div>
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-28 pb-20">
          <div className="max-w-3xl lg:max-w-4xl">
            ...
            <h1 className="font-display text-3xl sm:text-5xl md:text-6xl lg:text-7xl font-bold text-white leading-tight mb-6">
              <EditableField
                id="home-hero-h1-line1"
                label="Home › Hero › Headline — line 1"
                as="span"
              >
                BIG ENOUGH TO CARE,
              </EditableField>
            ...
            >
              To bring old-school maintenance and customer service back to the
              elevator industry by delivering reliable, honest, and
              non-proprietary solutions that put our customers — not
              manufacturers — first.
            </EditableField>
      ...
      <section className="py-24 bg-forge-light">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-14">
            ...
            >
              At Forge Elevator, we specialize in preventative maintenance,
              repairs, modernizations, inspections, and emergency service for
              all major elevator manufacturers. Our goal is simple: keep your
              elevators running safely, reliably, and efficiently while
              delivering the responsive service and personal attention that
              large corporations often overlook. Whether you need routine
              maintenance, a major modernization, or 24/7 support, Forge
              Elevator is committed to providing honest recommendations, quality
            ...
            {services.map(({ id, icon: Icon, title, desc }) => (
              <div key={id} className="card p-6 group">
                <div className="w-12 h-12 bg-forge-fire/10 rounded-sm flex items-center justify-center mb-5 group-hover:bg-forge-fire group-hover:text-forge-navy transition-colors">
                  <Icon
                    size={22}
                    className="text-forge-fire group-hover:text-forge-navy transition-colors"
                  />
                </div>
                <EditableField
          ...
          <div className="text-center mt-10">
            <Link
              to="/services"
              className="inline-flex items-center gap-2 text-forge-fire font-semibold hover:underline text-sm"
            >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className="relative">
            <div
              ...
              style={{
                backgroundImage: `url('/assets/elevator-glass.jpg')`,
                backgroundSize: "cover",
                backgroundPosition: "center",
              }}
            />
            ...
            <div className="absolute -bottom-5 -right-5 bg-forge-fire text-forge-navy rounded-sm p-5 shadow-xl hidden sm:block">
              ...
              <EditableField
                id="home-why-badge-value"
                label="Home › Why Forge › Badge value"
                as="p"
              ...
              <EditableField
                id="home-why-badge-label"
                label="Home › Why Forge › Badge label"
                as="p"
          ...
          <div>
            ...
            >
              When your elevator is down, every minute counts. Forge Elevator
              was built on the belief that building owners and managers deserve
              fast, honest, and expert service — without the runaround. We're
              your neighbors, and we stand behind our work.
            </EditableField>
            <ul className="space-y-3 mb-8">
              {why.map(({ id, text }) => (
                ...
                >
                  <CheckCircle2
                    size={17}
                    className="text-forge-fire mt-0.5 flex-shrink-0"
                  />
                  <EditableField
                    id={`home-why-${id}`}
      ...
      <section
        ...
        style={{
          background:
            "linear-gradient(135deg, rgb(var(--forge-navy-rgb)) 0%, rgb(var(--forge-steel-rgb)) 100%)",
        }}
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            Passenger entrapments and equipment failures can't wait for business
            hours. When your elevator is down, excuses don't get it running
            again. Our team is available 24/7 to deliver the responsive service
            and support your building deserves.
          </EditableField>
      ...
      <section className="bg-forge-light border-t border-forge-navy/10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 flex flex-col md:flex-row items-center gap-6 text-center md:text-left">
          ...
          <div>
            ...
            >
              Forge Elevator complies with all ASME A17.1 Safety Code
              requirements and Tennessee state elevator regulations. Our
              technicians hold current elevator mechanic licenses and receive
